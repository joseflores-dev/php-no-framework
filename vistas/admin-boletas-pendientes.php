            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <center>
                                <h1 class="m-0 text-dark ">Boletas Pendientes</h1>
                            </center>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($row as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="boleta-pendiente?boleta=<?php echo $value["id"];?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i></a>
