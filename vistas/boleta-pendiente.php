                            ...
                            <tbody>
                                ...
                                <?php foreach ($row as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-success editarCantidadBoleta" detalle_boleta="<?php echo $value["id"]; ?>"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                                <button type="button" class="btn btn-danger editarCantidadBoletaMinus" detalle_boleta="<?php echo $value["id"]; ?>"><i class="fa fa-minus" aria-hidden="true"></i></button>
                                            </div>  
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
