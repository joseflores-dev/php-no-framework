                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="admin-productos" class="small-box-footer">Ver <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <?php
                                    $cantidad = ControladorUsuarios::ctrContarUsuarios(1);
                                    echo ' <h3>'.$cantidad[0].'</h3>';
                                ?>
                            ...
                            <a href="admin-clientes" class="small-box-footer">Ver <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <?php
                                     $cantidad = ControladorUsuarios::ctrContarUsuarios(null);
                                     echo ' <h3>'.$cantidad[0].'</h3>';
                                ?>
                            ...
                            <a href="admin-trabajadores" class="small-box-footer">Ver<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                </div>
