                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <button class="btn btn-warning btnEditarProducto" data-toggle="modal" data-target="#modalEditarProducto" idProducto="<?php echo $value[" id"]; ?>"><i class="fa fa-pencil-square-o"></i></button>
